...
const SingleBlog = () => {
    ...
    const fetchBlog = async()=>{
        const response = await axios.get(`${baseUrl}v1/rental/vehicle-category/${slug}/`, {
        headers:{
    ...
    const onDelete = async()=>{
        try{
            const response = await axios.delete(`${baseUrl}v1/rental/vehicle-category/${slug}/`, {
            headers:{
                "Authorization":localStorage.getItem("token")
                }
            })
                        ...
                        <div className="md:flex-1 px-4">
                            ...
                            <div className="flex -mx-2 mb-4">
                                <Link to={`/blog/edit/${blog?.slug}`}>
                                    ...
                                    <div className="w-1/2 px-2">
                                        <button onClick={onDelete} className="w-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white py-2 px-4 rounded-full font-bold hover:bg-gray-300 dark:hover:bg-gray-600">Delete</button>
                                    </div>
